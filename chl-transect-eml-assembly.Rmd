...
author: "Jaxine Wolfe, Kate Morkeski"
...
#KM define R packages to require using require instead of libs and lapply
require(here)
require(tidyverse)
require(readxl)
require(lubridate)
...
#apply to api_chl_final: if filter size is >0 or <10, then mutate method_Sosik into column method_contributor
```
```{r}
api_chl_final  %>% 
    mutate(method_contributor  = case_when(filter_size=="<10" ~ "method_Sosik",         
                                           ...
                                           filter_size==">0" ~ "method_Sosik")) -> api_chl_final
...
#smd_chl_final$method_contributor <- "method_Menden-Deuer" #need to hard code the three records with a different method
#apply to smd_chl_final: filter to cruise en627 cast 30 niskin 1-2-3-4 then replace last 3 with method_contributor column with method_Menden-Deuer_no_200um
smd_chl_final  %>% 
    mutate(method_contributor  = case_when(cruise == "EN627" & ra_blank == "139.66" ~ "method_Menden-Deuer_no_200um",         
                                           cruise == "EN627" & ra_blank == "123.66" ~ "method_Menden-Deuer_no_200um", 
                                           cruise == "EN627" & ra_blank == "119.66" ~ "method_Menden-Deuer_no_200um",
                                           TRUE ~ "method_Menden-Deuer")) -> smd_chl_final
