...
```{r}
 ...
 # library(compareDF)
 # chl_previous <- read_csv('nes-lter-chl-transect-rosette-20230731.csv', show_col_types = FALSE) 
...
# Make EML Templates 
excel_to_template(here(metadata), edi_filename, rights='CC0', del_rights = FALSE)
