...
# add method_sample col (placeholder data)
smd_chl_final$method_sample <- "method_Menden-Deuer" #need to hard code the three records with a different method
#apply to smd_chl_final: filter to cruise en627 cast 30 niskin 1-2-3-4 if ra (or rb) = integer values 1, 2, or 3 then replace method_contributor column with method_Menden-Deuer_no_200um
# convert data types to enable cbind with smd data
