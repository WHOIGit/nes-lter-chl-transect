...
# original population of iode_quality_flag
#chl_qual <- chl_qual %>%
...
# use this when Sosik/Rynearson quality flags are updated, if provided as iode flags
# chl_qual <- chl_qual %>%
#    mutate(iode_quality_flag = case_when(method_contributor == "method_Menden-Deuer"  ~ iode_quality_flag,
#                                         method_contributor == "method_Rynearson" & cruise == "EN608" ~ 2,  # assuming Rynearson EN608 source remains the same
#                                         method_contributor != "method_Menden-Deuer"  ~ quality_flag,
#                                         ))
