...
#ar24missing <-read_csv('samples_lacking_bottle_metadata.csv', na = "")
...
## Change Quality Flag to IODE codes, Finalize Column Names, Write Output File
...
# having trouble making these separate chunks for some reason. 
 
 
# change some column names and properly identify a filtering scheme
chl_qual <- chl_qual %>%
