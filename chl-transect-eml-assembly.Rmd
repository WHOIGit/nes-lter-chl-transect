...
# EN727 one TAR sample needs quality changed from NaN to 1 (cast 5) Where cast == 5, change to 1. 
# EN727 Sosik samples missing need flag. Where flag and rb are NA, change flag to 9
# EN727 where method is NA and filter size is 3, replace with TAR and >20; 
