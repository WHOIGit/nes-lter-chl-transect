...
smd_chl_final <- smd_chl_final   %>%
        ...
        mutate(filter_size  = case_when(cruise == "EN627" & ra_blank == "139.66" ~ ">5",         
                                           cruise == "EN627" & ra_blank == "123.66" ~ ">5", 
                                           cruise == "EN627" & ra_blank == "119.66" ~ ">5",
                                           TRUE ~ filter_size) )
...
#chl_transect <- chl_transect[with(chl_all, order(cruise, match(cast, cast_sort), match(niskin, niskin_sort),
 #                                   match(filter_size, size_sort))), ]
#chl_transect <- chl_transect[with(chl_all, order(cruise, cast)), ]
# sorting results in AR24 excluded from chl_transect. why? 
