...
# Should we keep this? Distance column does not include distance value when distance is >2 km
```{r}
...
# chl_qual was formerly api_chl_final and transect_chl_final 
qa_transect <- chl_qual %>%
