...
ar24ooi <- ar24ooi %>% 
 mutate(
   niskin = ifelse(filter_id_ooi=="02/02", 
                   yes = 4, 
                   no = ar24ooi$niskin)) 
 ar24ooi <- ar24ooi %>% 
  mutate(
    niskin = ifelse(filter_id_ooi=="02/03", 
                   yes = 5, 
                   no = ar24ooi$niskin)) 
  ar24ooi <- ar24ooi %>% 
    mutate(
      niskin = ifelse(filter_id_ooi=="02/04", 
                   yes = 6, 
                   no = ar24ooi$niskin)) 

ar24ooi <- ar24ooi %>% 
   mutate(
        niskin = ifelse(filter_id_ooi=="02/06", 
                   yes = 8, 
                   no = ar24ooi$niskin)) 

ar24ooi <- ar24ooi %>% 
   mutate(
        niskin = ifelse(filter_id_ooi=="03/04", 
                   yes = 8, 
                   no = ar24ooi$niskin)) 
